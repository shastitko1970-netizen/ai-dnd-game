...
export class PromptService {
  ...
  static getSystemPrompt(
    ...
    return basePrompt
      ...
      .replace('{PREVIOUS_NARRATIVE}', truncatedHistory || 'Игра началась')
...
LANGUAGE: ТОЛЬКО РУССКИЙ (кириллица + пунктуация)
...
✅ ХОРОШО: "Ваш клинок распарывает плоть. Враг кричит от боли и отпрыгивает назад, кровь капает на пол. Его глаза горят яростью."
